...
var navTarget;
(function (navTarget) {
    navTarget["Instructions"] = "ins";
    navTarget["GamevsAI"] = "vAI";
    navTarget["Game1vs1"] = "1v1";
    navTarget["GameTournament"] = "tour";
})(navTarget || (navTarget = {}));
var ColourBox;
(function (ColourBox) {
    ColourBox["Red"] = "bg-red-500";
    ColourBox["Blue"] = "bg-blue-500";
...
const renderTabs = () => {
    ...
    */
    ...
    openFiles.forEach(file => {
        ...
        // <div class="${activeClass} file-tab items-center space-x-3 pl-4 pr-4 pt-2 pb-2 bg-neutral-800 border-t-2 border-t-blue-500 border-r border-gray-400/[0.20]" onclick="selectFile(${file.id})">
